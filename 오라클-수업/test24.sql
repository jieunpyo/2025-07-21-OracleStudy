...
/*
SELECT empno,ename,job
FROM (SELECT empno,ename,job,ROW_NUMBER() OVER(ORDER BY empno) AS rn FROM emp)
WHERE rn BETWEEN 6 AND 10;
*/
/*
     1. INSERT => rownum / rowid (인덱스)
     전체 번호 설정    :   SELECT rownum ....  => 이전/다음의 상세보기이동 
