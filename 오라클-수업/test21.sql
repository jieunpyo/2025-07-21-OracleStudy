...
/*
	...
	1. DDL : 정의 언어 => 단위 컬럼단위 => 자동 COMMIT
	   ...
	   1. table 제작 
	      ...
	      3) 제약조건 : 이상현상을 방지 (수정 , 삭제할때 원하지 않는 데이터에 
				영향이 있다)
		  1 홍길동 서울
		  2 홍길동 경기
		  3 홍길동 부산 
...
-- MAX
/*
INSERT INTO student VALUES((SELECT NVL(MAX(hakbun)+1,100) FROM
student),'홍길동',90,90,80,SYSDATE);
