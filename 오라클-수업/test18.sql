...
/*
	...
	형식)
		CREATE TABLE table_name(
			 ...
			 => PRIMARY KEY , FOREING KEY , CHECK , UNIQUE 
		)
...
--------------------------------------------
	...
	3. 테이블 연결 
	 ...
	 --------------------------------------------------------
	    체크						    >0
	 --------------------------------------------------------
	   데이터 형  VARCHAR2  DATE    VARCHAR2  NUMBER
	 --------------------------------------------------------
	    크기	     13			   51		   8,2
	 ---------------------------------------------------------------
	 ...
	 --------------------------------------------------------
	    체크						    >0
	 --------------------------------------------------------
	   데이터 형  VARCHAR2  VARCHAR2  NUMBER
	 --------------------------------------------------------
	    크기	     13	      51	       8,2
	 ---------------------------------------------------------------
	 ...
	 --------------------------------------------------------
	    체크						        >0
	 --------------------------------------------------------
	   데이터 형  VARCHAR2  VARCHAR2  NUMBER NUMBER NUMBER
	 -----------------------------------------------------------
...
/*
     1. NOT NULL  => MODIFY 컬럼명 데이터형 CONSTRINT ~
	...
	ALTER TABLE table_name DROP CONSTRAINT 이름 
						판매전표_전표번호_pk
     => 한번에 완성이 안된다 
	   컬럼 추가 , 컬럼 크기 변경 , 컬럼 삭제가 가능 => 184~185
...
ALTER TABLE 제품 ADD CONSTRAINT 제품_제품번호_pk PRIMARY KEY(전표번호);
ALTER TABLE 제품 ADD CONSTRAINT 제품_제품단가_ck CHECK(제품단가>0);
ALTER TABLE 제품 MODIFY CONSTRAINT 제품_제품명_nn NOT NULL;
