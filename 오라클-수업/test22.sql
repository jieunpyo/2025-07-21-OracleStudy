...
/*
	...
	1) SELECTÀÇ Çü½Ä , ¼ø¼­ 
	   ...
	   [
		WHERE Á¶°Ç¹® (¿¬»êÀÚ)
		GROUP BY ±×·ìÄÃ·³|ÇÔ¼ö => ±×·ìº° Åë°è => °ü¸®ÀÚÆäÀÌÁö 
		HAVING ±×·ì Á¶°Ç 
...
*/
/*
INSERT INTO emp VALUES(8000,
 'È«±æµ¿','´ë¸®',7788,SYSDATE,2500,0,10);
COMMIT;
     A-Za-z	   0-9  °¡-ÆR
*/
/*
...
INSERT INTO emp VALUES(8001,
 'ABCÈ«±æµ¿','´ë¸®',7788,SYSDATE,2500,0,10);
INSERT INTO emp VALUES(8002,
 'È«±æµ¿ABC','´ë¸®',7788,SYSDATE,2500,0,10);
COMMIT;
*/
/*
SELECT *
